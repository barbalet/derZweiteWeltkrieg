...
public enum GuderianCampaignCatalog {
    public static let all: [GuderianScenario] = [
        makeScenario(
            ...
            forces: [force("Opposing side", "Polish corridor defenders", "delay and withdraw"), force("Guderian command", "XIX Panzer Corps spearheads", "break through")]
        ),
        makeScenario(
            .wizna,
            order: 2,
            ...
            forces: [force("Opposing side", "Polish Wizna defenders", "fortified delay"), force("Guderian command", "German panzer and artillery assault group", "reduce bunkers")]
        ),
        makeScenario(
            .brzescLitewski,
            order: 3,
            ...
            forces: [force("Opposing side", "Brzesc defense group", "fortress defense"), force("Guderian command", "XIX Panzer Corps assault columns", "capture fortress")]
        ),
        makeScenario(
            .kobryn,
            order: 4,
            ...
            forces: [force("Opposing side", "Operational Group Polesie", "rearguard withdrawal"), force("Guderian command", "German motorized infantry", "fix and encircle")]
        ),
        makeScenario(
            .sedan,
            order: 5,
        ...
        makeScenario(
            ...
            forces: [force("Opposing side", "Soviet Tula, Kashira, Belov/Getman reserve, and winter counteroffensive defenders", "winter defense"), force("Guderian command", "2nd Panzer Army southern pincer", "break southern approach")]
        ),
    ]
